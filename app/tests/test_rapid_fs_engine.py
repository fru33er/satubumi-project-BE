...
class TestRapidFSEngine(unittest.TestCase):
    def test_rapid_fs_calculation_tropical_forest(self):
        ...
        self.assertEqual(result.acc_total_credits, 7500000.0)  # 50k * 5 * 30 = 7.5M tCO2e
    ...
    def test_rapid_fs_mangrove_ecosystem(self):
        ...
        self.assertEqual(result.emission_reduction_rate, 10.0)  # Mangrove rate 10 tCO2e/ha/yr
