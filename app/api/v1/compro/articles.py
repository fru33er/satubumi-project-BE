...
@router.post(
    "/{article_id}/media",
    response_model=ArticleMediaUploadResponse,
    summary="Upload Media / Gambar Inline Artikel",
)
async def upload_article_media(
    ...
    unique_filename = f"{uuid.uuid4().hex}{ext}"
    storage_path = f"articles/media/{unique_filename}"
